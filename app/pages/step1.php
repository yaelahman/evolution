<div class="lg:col-span-4 col-span-8 md:p-12 p-3 md:pb-3 pb-24">
    <form action="" class="h-full flex flex-col">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-header 2xl:text-4xl lg:text-2xl text-xl font-semibold 2xl:mb-6 mb-3">Scope of Work & Photos
            </h1>
        ...
        <div
            class="lg:relative mt-auto fixed bottom-0 w-full left-0 lg:p-0 p-4 pt-2 border-t-2 lg:border-transparent border-gray bg-white">
            <div class="flex w-full items-center lg:pt-5 lg:mt-12 gap-2 ps-2 lg:ps-0">
