<div class="lg:col-span-4 col-span-8 md:p-12 p-3">
    <form action="" class="h-full flex flex-col">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-header 2xl:text-4xl lg:text-3xl text-2xl font-semibold mb-6">Inspiration Photos
            </h1>
                    ...
                    <div class="flex items-center flex-col">
                        <div class="flex gap-2">
                            ...
                            <h6 class="text-header font-medium"><span id="btnUploadStepOne"
                                    class="text-secondary cursor-pointer">Upload</span> files of the space</h6> <br>
                        </div>
            ...
            <div class="flex flex-col gap-1 my-8">
                <div class="flex flex-col">
                    <label class="flex items-center">
                        <input type="checkbox" name="trust" value="1" class="mr-2 h-6 w-6 border border-header">
